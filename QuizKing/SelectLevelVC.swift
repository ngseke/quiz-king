...
class SelectLevelVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.difficultLable.font = cell.difficultLable.font.withSize(32)
        cell.moneyLable.text = moneyList[indexPath.row]
        cell.moneyLable.font = cell.moneyLable.font.withSize(32)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "goLoading" {
            ...
            (segue.destination as! LoadingVC).difficult = difficultList[index!].lowercased()
        }
    }
}
