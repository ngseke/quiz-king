...
class GameOverVC: UIViewController {
    ...
    @IBAction func share(_ sender: UIButton) {
        let activityVC = UIActivityViewController(activityItems: ["我在 Quiz King 中獲得了 " + String(score) + " 分，厲害吧！尼要不要也來玩玩看？", "https://github.com/seanyellow/quiz-king"], applicationActivities: nil)
